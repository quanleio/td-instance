...
import { BufferGeometryLoader, MeshPhongMaterial, InstancedMesh, Color, Vector3, Matrix4 } from 'https://unpkg.com/three@0.130.0/build/three.module.js';

function addModel() {

  return new Promise((resolve, reject) => {
    new BufferGeometryLoader().load('../assets/suzanne_buffergeometry.json', ( buffGeo ) => {
      // console.error(buffGeo);

      buffGeo.computeVertexNormals();
      makeInstance( buffGeo ).then(_instancedMesh => resolve(_instancedMesh));
    }, onProgress, onError);
  })
}
